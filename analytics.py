...
def write_to_csv_departments(time,teachingscore,teaching,courseContentscore,courseContent,
    ...
    with open('C:/Users/pavan/Downloads/Student_Feedback_System-main/Student_Feedback_System-main/dataset/database.csv', 'r') as f:
        reader = csv.reader(f)
        for header in reader:
            break
    with open('C:/Users/pavan/Downloads/Student_Feedback_System-main/Student_Feedback_System-main/dataset/database.csv', "a", newline='') as f:
...
def write_to_csv_teachers(teacher1,teacher1score,teacher2,teacher2score,teacher3,teacher3score,
    ...
    with open('C:/Users/pavan/Downloads/Student_Feedback_System-main/Student_Feedback_System-main/dataset/teacherdb.csv', 'r') as f:
        reader = csv.reader(f)
        for header in reader:
            break
    with open('C:/Users/pavan/Downloads/Student_Feedback_System-main/Student_Feedback_System-main/dataset/teacherdb.csv', "a", newline='') as f:
        writer = csv.DictWriter(f, fieldnames=header)
...
def get_counts():
    path = 'C:/Users/pavan/Downloads/Student_Feedback_System-main/Student_Feedback_System-main/dataset/database.csv'
    df = pd.read_csv(path)
    index = df.index
...
def get_tables():
    df= pd.read_csv('C:/Users/pavan/Downloads/Student_Feedback_System-main/Student_Feedback_System-main/dataset/database.csv')
    df = df.tail(5)
